/**──────────────────────────────────────────────────────────────────────┐
│  📝 TYPOGRAPHY TAB FEATURE                                            │
│  /src/features/admin/showcase-page/_tabs/TypographyTab.tsx           │
│                                                                       │
│  VR Doctrine: Feature Layer                                          │
│  Complete typography showcase with all variants and examples          │
└────────────────────────────────────────────────────────────────────────┘ */
...
export function TypographyTab() {
  return (
    ...
    >
      ...
      <div>
        <Typography.caption size="sm" weight="normal" color="tertiary">
          Small caption, normal weight, tertiary (sm, normal, tertiary)
        </Typography.caption>
      </div>

      <div>
        <Typography.caption color="tertiary" italic>
          Caption with italic style (tertiary, italic)
        </Typography.caption>
      </div>
      ...
      <div>
        <Typography.caption size="sm" weight="normal" color="tertiary">Small, normal weight, tertiary color</Typography.caption>
      </div>
      <div>
